...
static int sys_msg_add_writable = 0;
...
static void __ixc_sys_msg_handle_port_req(struct sockaddr_in *to_addr)
{
    ...
    ixc_netpkt_key_get(buf);
    ixc_netpkt_port_get((unsigned short *)(buf + 16));
